...
export default function App() {
  ...
  async function convert(file) {
    const { renderer, rgbeLoader, pmremGenerator, ctx } = depsRef.current;
  ...
  return (
    <div className="page">
      ...
      <div className="diff-can">
        <svg viewBox="0 0 2 1" style="width: 100%;"></svg>
        <div className="diff">
      ...
      <div className="size-table">
        <div className="size-table-item"></div>
        ...
        {sizeTable.map(({ name, original, exported }, i) => (
          <div className="size-table-row">
            <div>{name}</div>
